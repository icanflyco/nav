...
?>
    ...
    <div class="col-12">
        <?php
        foreach ($data['form-data-2post'] as $posts) {
            #Explode 1
            ...
            if($dataExplode[0] == $_SESSION['access_tokenkey'] || $data['form-data-users-tab']['tokenkey_id'] == $_SESSION['access_tokenkey'] && $data['form-data-users-tab']['idposts']){
                $nones = "d-none";
            }else{
                $nones = "";
            }
        ?>
            <!---- Posted Image 1---->
            <div class="mt-1 <?php echo $nones; ?> mt-lg-2 mt-md-2 yu-border-y-1" id="Loves_<?php echo $posts['idposts']; ?>">
                <div class="d-flex flex-row" data-bs-spy="scroll" data-bs-target="#Lovesid_<?php echo $posts['idposts']; ?>" data-bs-offset="0" tabindex="0">
                    <div class="col-2 col-md-1 col-lg-1 position-relative" id="Lovesid_<?php echo $posts['idposts']; ?>" style="z-index:3;">
                        <div class="p-2 h-100">
                            <div class="yu-pos-sticky-img_1 text-center">
                                <img id="yu-sticky_1" onerror='this.src="<?php echo BASEURL; ?>foto/default/default-jpg.jpg"' src="<?php echo BASEURL; ?>foto/profiles/<?php echo $data['form-data-user']['foto_profile'];
                    ...
                    <div class="col-9 col-md-10 col-lg-10 px-md-2 position-relative">
                        ...
                        <h2 class="m-0 h6 pt-2 fw-bold position-relative">
                            ...
                            <?php Conditions::centang($data['form-data-user']['centang']); ?> • <a href="#" class="text-decoration-none" style="font-size:12.5px;">Follow</a></h2>
                        <div class=" text-dark position-relative">
                            <small class="yu-fs-md-0"><span style='font-size:13px;'><a href="<?php echo BASEURL; ?>p/<?php echo $data['form-data-user']['nama_pengguna']; ?>" class="text-decoration-none text-secondary fw-bold">
                                    ...
                                    ?>
                                            <div class="d-flex position-relative">
                                                ...
                                                <div class="col-9 col-md-10 col-lg-10">
                                                    ...
                                                    <small><a class="fw-bold text-secondary text-decoration-none" href="<?php echo BASEURL; ?>p/<?php echo $data['form-data-user-dua']['nama_pengguna']; ?>">@<?php echo $data['form-data-user-dua']['nama_pengguna']; ?></a></small>
                        ...
                        <div class="text-secondary postStatus">
                            ...
                            <small class="yu-fs-sm-1"> <span class="py-1 fw-bold px-2 rounded-pill" style="border:2px solid #f2f2f2;"><?php echo $posts['dates']; ?></span> <span class="position-relative  py-1 fw-bold px-2 rounded-pill" style="border:2px solid #f2f2f2;">
                                    <div class='yu-lines-4'></div>
                                    <span href="" class="text-decoration-none text-secondary"><i class="bi-eye text-secondary" style="position:relative;top:0.5px;"></i></span> <span class="text-secondary fw-bold" style="position:relative;top:-0.5px;"><?php
                        ...
                        <div class="mb-3 mt-2">
                            <div class="d-flex flex-row yu-fo">
                                <div class="position-relative yu-mr-1">
                                    <a class="text-decoration-none text-secondary <?php Conditions::iloves($_SESSION['access_tokenkey'], $data['form-data-iloves']['idposts'], $data['form-data-iloves']['roles']); ?>" id="Loves_<?php echo $posts['idposts']; ?>" href="<?php echo BASEURL; ?>home/<?php echo Conditions::i4loves($_SESSION['access_tokenkey'], $data['form-data-iloves']['idposts'], $data['form-data-iloves']['roles']); ?>/<?php echo $posts['idposts']; ?>"><i class="bi-heart<?php Conditions::i2loves($_SESSION['access_tokenkey'], $data['form-data-iloves']['idposts'], $data['form-data-iloves']['roles']); ?>"></i></a><span class="mx-1 text<?php Conditions::i3loves($_SESSION['access_tokenkey'], $data['form-data-iloves']['idposts'], $data['form-data-iloves']['roles']); ?> yu-fo-re-1"><?php echo $data['form-data-icount']['total']; ?></span>
                                </div>

                                <div class="position-relative yu-mr-1">
                                    <a href="<?php echo BASEURL; ?>home/<?php Conditions::repost3Status($_SESSION['access_tokenkey'], $data['form-data-irepost']['idposts'], $data['form-data-irepost']['roles']); ?>/<?php echo $posts['idposts']; ?>" class="text-decoration-none text-secondary  <?php Conditions::repostStatus($_SESSION['access_tokenkey'], $data['form-data-irepost']['idposts'], $data['form-data-irepost']['roles']); ?>"><i class="bi-repeat yu-fs-md-1"></i></a> <span class=" <?php Conditions::repost2Status($_SESSION['access_tokenkey'], $data['form-data-irepost']['idposts'], $data['form-data-irepost']['roles']); ?> yu-fo-re-1"><?php echo $data['form-data-rcount']['total']; ?></span>
                                </div>
                                <div class="position-relative yu-mr-1">
                                    <a href="<?php echo BASEURL; ?>posts/read/<?php echo $posts['idposts']; ?>" class="text-decoration-none text-secondary"><i class="bi-chat text-secondary"></i></a>
                                    <span class="text-secondary yu-fo-re-1"><?php echo $data['form-data-comcount']['total']; ?></span>
                                </div>
                                <div class="position-relative yu-mr-1">
                                    <a href="<?php echo BASEURL; ?>home/share/<?php echo $posts['idposts']; ?>" class="text-decoration-none text-secondary"><i class="bi-share text-secondary"></i></a>
                                </div>
                            </div>
                        </div>
                    </div>
