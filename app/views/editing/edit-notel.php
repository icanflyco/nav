...
if ($data['mobile'] == "Is Mobile" && $data['form-profiles']['tokenkey'] == $_SESSION['access_tokenkey']) {
    ...
    <div class="col-12 col-lg-6 col-md-9">
        ...
        <a onclick="back()" class="text-decoration-none text-secondary yu-pos-x-1"><i class="bi-x-circle fs-3"></i></a>
            ...
            <div class="my-2">
                <form action="<?php echo BASEURL; ?>edit/numb/<?php echo "NUM-".base64_encode($data['form-profiles']['nama_pengguna']."_easly_".$_SESSION['access_tokenkey']); ?>" method="POST">
                   <div class="mt-3 col-12 col-lg-4 col-md-4">
                    <div class="form-group mb-2">
                        <label for="No Telp. (SMS & WhatdApp)" class="mb-2 fw-bold">Numb. Phone (SMS & WhatsApp)</label>
                        <input type="number" name="notelp" class="form-control w-100" value="<?php echo $data['form-profiles']['no_telpon']; ?>" autocomplete="off" placeholder="Number Phone" />
                    </div>
